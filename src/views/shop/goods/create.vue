<template>
	<div class="bg-white px-3 goods_create" style="margin: -20px;margin-top: -1rem; margin-bottom: 0!important;">
		<router-link :to="{name:'shop_goods_list'}" style="position: absolute; top: 12px;left: 200px;">
			<el-button size="mini">返回到商品列表</el-button>
		</router-link>
				...
				<template v-else>
					...
					<el-form ref="form" label-width="80px">
						<el-form-item label="添加规格">
							...
							@click="addSukCard" >添加规格</el-button>
						</el-form-item>
					</el-form>
					<el-form ref="form"  label-width="80px">
						<el-form-item label="批量设置">
							...
							<el-button type="text">库存价</el-button>
							<el-button type="text">体积价</el-button>
...
<script>
	...
	export default {
		...
		methods: {
			...mapMutations(['addSukCard','vModelState']),
			//修改表单的值
			vModel(key,value){
