		...
		<el-container style="position: absolute;top: 55px;left: 0;right: 0;bottom: 0;">
			<el-header class="d-flex align-items-center border-bottom">
				...
				<div class="d-flex mr-auto">
					<el-select  placeholder="请选择图片排序方式" class="mr-2"
					 size="mini" style="width: 150px;" v-model="searchForm.order">
						<el-option label="区域一" value="shanghai"></el-option>
						<el-option label="区域二" value="beijing"></el-option>
					</el-select>
					<el-input size="mini" style="width: 150px;" class="mr-2" placeholder="输入相册名称" 
							...
							v-for="(item,index) in imageList" :key="index ">
								...
								:body-style="{'padding':'0'}" shadow="hover">
									<div class="border" :class="{'border-danger':item.ischeck}">
										...
										<div class="w-100 text-white px-2" style="background: rgba(0,0,0,0.5);margin-top: -25px; position: absolute;">
											<span class="small">{{item.name}}</span>
										</div>
										<div class="p-2 text-center">
											<el-button-group>
											  <el-button  icon="el-icon-view" size="mini" class="p-2" @click="previewImg(item)"></el-button>
