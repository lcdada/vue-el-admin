<template>
	<el-form ref="form" label-width="80px">
		<el-form-item label="商品名称">
			<el-input :value="title" @input="vModel('title',$event)" placeholder="请输入商品名称,不能超出60个字符" class="w-50"></el-input>
		</el-form-item>
		<el-form-item label="商品分类">
			<el-cascader :value="category" @input="vModel('category',$event)" :options="options"></el-cascader>
		</el-form-item>
		<el-form-item label="商品描述">
			<el-input type="textarea" :value="desc" @input="vModel('desc',$event)" placeholder="选填商品卖点描述" class="w-50"></el-input>
		</el-form-item>
		...
		<el-form-item label="库存显示">
			<el-radio-group :value="display_stoke" @input="vModel('display_stoke',$event)">
	...
	export default{
		...
		computed:{
			...mapState({
				...
				display_stoke:state=>state.goods_create.display_stoke,
